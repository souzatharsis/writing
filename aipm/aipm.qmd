...
author:
  - name: Thársis Souza 
citation:
  url: https://www.souzatharsis.com/essays/aipm
...
2. **Anthropomorphization of AI** - As AI systems become more sophisticated in natural interactions, AI ease of use is at the highest level ever to the extent human-like qualities are increasingly attributed AI-powered products, fundamentally reshaping user experience therefore changing how we relate and interface with technology.
...
As we can see in see in @fig-llmflation, a model achieving an MMLU score of 42 that cost \$60 per million tokens in late 2021 can now be run for just \$0.06 per million tokens. For higher-capability models scoring 83 on MMLU, prices have fallen by a factor of 62 since GPT-4's introduction in March 2023. 
...
Suddenly, AI's capabilities are no longer something far away from the user, hard to grasp. Instead, AI's potential can be leveraged by anyone through a simple interface. Arguably, the user experience enabled by aligned models provides the much needed bridge between AI's powerful capabilities and layman's users.
...
1. **Democratization of AI Development**: Generative AI is dramatically lowering the barriers to entry for building AI-powered products. With the emergence of foundation models, APIs, and no-code tools, teams can now integrate sophisticated AI capabilities without requiring deep expertise in machine learning. This enables innovation at scale while raising the important of prioritization the right problems to solve rather than the AI technologies to use per se.
...
These factors are reshaping the role of Product Management in the age of AI. What skills are needed? What roles are emerging? What tools are needed? Let's explore these questions in more detail in the next sections.
...
3. AI-powered PM: Oversees products where AI enhances and improves existing functionality but is not essential to the core product. The product can function without AI. Examples include AI-enhanced search recommendations, smart email composition, or automated customer support routing.

I'd argue, all PMs will an AI PM. The more you are focused on AI, the more you will be in the first two roles. The remaining PMs, perhaps the majority, will be in the third role.
...
- While AI enables faster prototyping and reduces handoffs, core functional expertise remains valuable
...
- Rather than collapsing roles, AI empowers each function to work more effectively, in turn role's deep expertise makes AI more effective.
...
[^discovery]: In Appendix A, we provide a brief discussion on how GenAI is changing the nature of product discovery, and the product manager's role in product discovery.
...
As AI transforms product development, it's driving several fundamental changes to how we approach these deliverables:

1. **The End of Product Specification Reviews**
   - Traditional product spec reviews, at least as we know it
   - Teams can quickly create working prototypes to validate ideas iteratively instead of debating specifications
   - Interactive prototypes provide better context and feedback than static documents
...
2. **From PRDs to Evaluation Frameworks**
   - Traditional PRDs focus on deterministic features and fixed requirements
   ...
   - The new PRD might be reshaped as a combination of evaluation frameworks and interactive prototypes

3. **The End of Documentation as we know it**
   - Arguably, nobody reads documentation anymore.
   - Traditional documentation will be replaced by two key elements:
     - For humans: Interactive Product Playgrounds
     ...
     - For AIs: LLMs.txt Specification[^llmstxt]
...
- Competitive differentiation strategy in AI-first products
- Model selection and evaluation criteria
- Go-to-market strategy for AI features
- Data strategy and sourcing plans

**Evaluation Frameworks (The New PRD)**
...
- User interaction flows with AI features
...
A) IDEs & Code Editors
- Cursor: Best overall AI-powered IDE
- WindSurf: Best for web development
- GitHub Copilot: Most mature AI coding assistant

B) Low/No-Code Tools  
- v0.dev: Best for UI prototyping
- bolt.new: Best for full-stack application generation

[^ide-tools]: The Pragmatic Engineer newsletter has a great list of IDEs with GenAI features: https://newsletter.pragmaticengineer.com/p/ide-that-software-engineers-love
...
- Gemini Deep Research: Best for web-based research
...
As GenAI technologies advance coupled with the pervasive belief that AI will solve all challenges, there is a risk of over-reliance on AI systems. This risk is exacerbated as boundaries of what's human versus AI responsibility becomes increasingly unclear, leading to oftentimes excessive delegation of critical thinking and decision-making to machines, which can lead to several key pitfalls, including but not limited to the following:
...
4. **Misunderstanding AI Capabilities**
   ...
   - More and more technical expertise will become part of the PM job description to avoid "Black Box Thinking", i.e. treating AI as magical rather than understanding its limitations and constraints as well as potentials to close the gaps between AI promises and reality.
...
- AI won't replace humans, but humans augmented by AI will replace humans who don't embrace AI's capabilities and potential.
