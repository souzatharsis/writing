...
In fact, @fig-llmflation is already outdated since the release of China's DeepSeek V3 and R1 models in the weeks, which deliver performance on par with leading OpenAI and Anthropic models at a fraction of the cost causing a $1.5T market cap crash in the US market [@wsj2024deepseek].
