...
**Abstract** *This article examines how Generative AI is transforming the role of Product Management driven by three key trends: the rapidly declining cost of AI capabilities, the increasing anthropomorphization of AI interfaces, and the emergence of human agency. We analyze how these shifts are reshaping traditional Product Management responsibilities, skill requirements, and team dynamics. We also outline common pitfalls to avoid, and explore essential GenAI tools for Product Managers. We argue all PMs will soon be AI PMs but at the same time the core tenets of product management remain more critical than ever, namely, deep problem understanding, business acumen, and user empathy.*
...
In fact, @fig-llmflation is already outdated since the release of China's DeepSeek V3 and R1 models in past weeks, which deliver performance on par with leading OpenAI and Anthropic models at a fraction of the cost causing a $1.5T market cap crash in the US market [@wsj2024deepseek].

::: {.callout-tip}
## Point in Favor of AI PM
Writing software is becoming cheaper enabled by high-performant code generation LLM models. This will lead to increased demand for people who can decide what to build rather than how to build it. 
:::
...
As a consequence, technology products built with generative AI more and more present themselves as speaking, listening, and seeing like humans. 

More recently, there is another dimension of anthropomorphism: "Reasoning". This is arguably, another emerging scaling law: Test-Time Compute, where LLM proposes a sequence of answers and revisions at inference time, hence simulating "reasoning" as illustrated in @fig-test-time-compute. In this example, DeepSeek's recent (market crashing) reasoning model is able to "rethink" the problem and propose a sequence of answers and revisions.

::: {.column-margin}
![The model learns to "rethink" using an anthropomorphic tone. DeekSeek's technical paper [@deepseekai2025deepseekr1incentivizingreasoningcapability] reads:"This is also an aha moment for us, allowing us to witness the power and beauty of reinforcement learning."](aha.png){#fig-test-time-compute}
:::


Suddenly, AI's capabilities are no longer something far away from the user; hard to grasp. Instead, AI's potential can be leveraged by anyone through a simple anthropomorphic interface. Arguably, this enhanced user experience provides the much needed bridge between AI's powerful capabilities and layman's users. It is not just about the AI being capable but also being easy to use.
...
AI is breaking down traditional role silos among product management, design, and engineering - roles that were previously specialized and distinct are now becoming more overlapping towards a more generalist approach - a converging GenAI-powered role (see @fig-genai). This perspective suggests:
...
::: {.callout-note}
Under this view, in the limit, we would see the first one-person billion dollar company soon emerging[^wef].
:::

[^wef]: 2025 World Economic Forum, [One-Person Enterprise](https://www.youtube.com/watch?v=vhXJr_zSJOc).
...
Once you become obsessed with the problem, you start walking backwards from the problem to the solution and that's when you start to understand the technical constraints and possibilities. Learning GenAI capabilities[^ms-course] comes as a consequence of the problem solving process.

[^ms-course]: [Generative AI for Beginners](https://github.com/microsoft/generative-ai-for-beginners) by Microsoft is a great resource for getting started with building with GenAI.
...
- [Taming LLMs](https://tamingllms.com/) by Thársis

## Appendix C: DeepSeek-R1

Here's DeepSeek-R1's answer to the question: "Will Product Managers survive the Generative AI revolution?".

The role of Product Managers (PMs) will evolve rather than disappear in the face of the Generative AI revolution. Here's a structured analysis of how PMs will adapt and thrive:

**Augmentation, Not Replacement**

- **Data-Driven Insights**: Generative AI can process vast datasets to identify customer needs, market trends, and feature priorities, but PMs will interpret these insights within strategic and ethical contexts.
- **Efficiency Gains**: Automating administrative tasks (e.g., report generation, documentation) allows PMs to focus on high-value activities like vision-setting and stakeholder collaboration.

**Human-Centric Skills Remain Critical**

- **Strategic Vision**: Aligning product goals with business objectives requires creativity and intuition—areas where human judgment outperforms AI.
- **Cross-Functional Leadership**: Building trust, negotiating priorities, and motivating teams rely on emotional intelligence, which AI cannot replicate.
- **Ethical and Empathetic Decision-Making**: Navigating complex moral dilemmas and ensuring inclusivity demands human oversight.

**Evolution of the PM Role**

- **AI Collaboration**: PMs will increasingly act as "translators" between AI outputs and actionable strategies, leveraging tools to enhance decision-making.
- **New Opportunities**: Managing AI-driven products (e.g., generative models, ethical AI systems) will require PMs with technical literacy and market expertise.
- **Focus on Innovation**: Freed from routine tasks, PMs can prioritize experimentation, long-term roadmaps, and disruptive ideas.

**Industry Parallels**

- **Job Transformation**: Like ATMs for bank tellers, AI will shift PM roles toward strategic advisory and creative problem-solving rather than eliminating them.
- **Demand in AI-Centric Sectors**: As AI products proliferate, PMs with expertise in AI governance, user experience, and scalability will be in higher demand.

**Conclusion**
Product Managers who embrace AI as a collaborative tool—while honing uniquely human skills like leadership, empathy, and strategic thinking—will not only survive but lead innovation. Adaptation is key: PMs must upskill in AI literacy, ethical oversight, and cross-functional collaboration to thrive in an AI-augmented future. Those resistant to change may struggle, but the role itself is poised to grow in significance as products become more complex and AI-dependent.